...
\\\multirow{3}{*}{\includegraphics[scale=0.08]{UPV_logo.png}}&B.S. Telecommunications Engineering, GPA: 8.9/10, Ranking: 2nd in year
...
\\\multirow{3}{*}{\includegraphics[scale=0.038]{Montblanc_logo.png}}&Systems and Network Administrator Intern
...
\section*{Projects}
\begin{tabular}{L!{\VRule}R}
    \multicolumn{2}{l}{(A more thorough list can be found at my personal website \href{http://afranques.com/projects/}{afranques.com/projects})}
    \\[5pt]
